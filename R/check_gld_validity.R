...
#' @keywords lambdas
#' @examples
#' suq2.utils.checkGLDValid1(lambdas)
#' @export
#'
suq2.utils.checkGLDValid1 <- function(lambdas){
...
#' @keywords lambdas
#' @examples
#' suq2.utils.checkGLDValidN(lambdas)
#' @export
#'
suq2.utils.checkGLDValidN <- function(lambdas){
  n = length(lambdas[,1])
