suq2.plot.gldByCluster <- function(cluster_number, n){
  lista = list()
...
suq2.plot.gldByCluster2 <- function(cluster_number, n){
  lista = list()
...
suq2.plot.clusters.l3l4 <- function(cluster_number, color) {
